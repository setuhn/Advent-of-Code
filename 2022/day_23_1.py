# -*- coding: utf-8 -*-
"""
Created on Fri Dec 23 07:43:46 2022
...
map_np = np.vstack((np.zeros((15, map_np.shape[1])), map_np, np.zeros((15, map_np.shape[1]))))
map_np = np.hstack((np.zeros((map_np.shape[0], 15)), map_np, np.zeros((map_np.shape[0], 15))))
...
map_np = trim_map(map_np)
print(np.count_nonzero(map_np == 0))