...
if __name__ == '__main__':
    ...
    for direction in direction_list:
        ...
        history[(start_cell, direction)] = 0 # coordinates, direction: heat_loss_tot
        ...
        for next_coordinates, next_direction in get_next_coor_direct_from(current_path, end_cell):
            ...
            if next_coordinates == end_cell:
                ...
                if min_heat_loss > next_heat_loss_tot:
                    ...
                    print(next_heat_loss_tot, len(path_sorted_list), counter, current_path[5])

                continue

            # If the branch is already recorded and the heat loss is bigger, prune this branch
            if (next_coordinates, next_direction) in history and history[next_coordinates, next_direction] < next_heat_loss_tot:
                continue

            else:
                # Update history
                history[(next_coordinates, next_direction)] = next_heat_loss_tot
